...
public abstract class OmsOrderBase : IOrder
{
    ...
    public override string ToString() =>
        $"Id: {Id}, Symbol: {Symbol}, Side: {Side}, Price: {Price}, Quantity: {Quantity}, State: {State}, ParentId: {ParentOrderId},  Strategy: {Strategy}, PendingQuantity: {PendingQuantity}, FilledQuantity: {FilledQuantity}, CancelState: {CancelState}";
}