...
public class SendingOrderSteps
{
    ...
    public SendingOrderSteps(ScenarioHelper scenarioHelper) => _scenarioHelper = scenarioHelper;
    ...
    private async Task InsertOrder(StrategyTypes strategyType) => _scenarioHelper.OrderId = await Hooks.Hooks.SimulationContext.OrderManagementSystemSimulator.Insert("AZN.L", Side.Buy, 100, 10000,
