...
static IReadOnlyDictionary<string, ICommand> RegisterCommands(
   params ICommand[] commands)
   => commands.ToDictionary(c => c.Name, c => c);

static bool ExecuteCommand(IReadOnlyDictionary<string, ICommand> commands, IReadOnlyList<string> input)
{
