...
public static class Settings
{
    ...
    {
        new(TradingSessionType.MarketClosed, TimeSpan.Parse("00:00:00"), TimeSpan.Parse("7:00:00")),
        new(TradingSessionType.OpenAuction, TimeSpan.Parse("7:00:00"), TimeSpan.Parse("8:00:00")),
        new(TradingSessionType.ContinuesTrading, TimeSpan.Parse("8:00:00"), TimeSpan.Parse("12:00:00")),
        new(TradingSessionType.IntradayAuction, TimeSpan.Parse("12:00:00"), TimeSpan.Parse("12:05:00")),
        new(TradingSessionType.ContinuesTrading, TimeSpan.Parse("12:05:00"), TimeSpan.Parse("16:30:00")),
        new(TradingSessionType.IntradayAuction, TimeSpan.Parse("16:30:00"), TimeSpan.Parse("16:35:00")),
        new(TradingSessionType.MarketClosed, TimeSpan.Parse("16:35:00"), TimeSpan.Parse("24:00:00")),
    };
