...
public class Sniper : IStrategy
{
    ...
    public void onNewMarketData(MarketData marketData) => _state = _state.MarketDataReceived(marketData);
    ...
    private static bool IsParentOrder(TsOrder order) => order.ParentOrderId == null;
