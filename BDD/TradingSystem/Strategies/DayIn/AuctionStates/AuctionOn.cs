...
{
    public AuctionOn(StrategyContext ctx) => Context = ctx;
    ...
    public void OnParentModificationRequested(TsOrder newParent) => Context.OrderManager.Reject(newParent);
    ...
    public void OnChildRejected() => Context.OrderManager.SendChild(Context.ParentOrder);
